  ...
  return (
    <div className="analysis-page">
      ...
      <style jsx>{`
        ...
        .analysis-header h2 { font-size: 1.5rem; font-weight: 800; color: var(--color-chessboard-ivory); margin-bottom: 0.5rem; font-family: var(--font-display); }
        .analysis-subtitle { color: var(--color-chessboard-smoke); font-size: 0.9rem; font-family: var(--font-body, serif); }
        ...
        .analysis-heading { font-size: 1.15rem; font-weight: 700; color: var(--color-chessboard-gold); margin: 1.5rem 0 0.6rem 0; padding-bottom: 0.4rem; border-bottom: 1px solid rgba(201, 162, 39, 0.2); font-family: var(--font-display); }
        ...
        .bullet { color: var(--color-chessboard-gold); font-weight: 700; flex-shrink: 0; }
