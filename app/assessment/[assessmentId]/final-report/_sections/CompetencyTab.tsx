...
export function CompetencyTab({ report }: { report: EvaluationReport }) {
  ...
  return (
    <div className="comp-page">
      ...
      {/* Radar Chart */}
      <div className="radar-chart bg-[color:var(--color-chessboard-rampart)] p-6 rounded-2xl mb-8 border border-[color:var(--color-chessboard-ash)]/20">
        <h3 className="text-xl font-bold mb-4" style={{ fontFamily: 'var(--font-display)', color: 'var(--color-chessboard-ivory)' }}>Competency Radar</h3>
      ...
      <style jsx>{`
        ...
        .archetype-badge { display: inline-block; background: linear-gradient(135deg, var(--color-chessboard-gold), var(--color-chessboard-gold-bright)); color: var(--primary-foreground); padding: 0.6rem 2rem; border-radius: 12px; font-size: 1.3rem; font-weight: 700; margin-bottom: 0.8rem; font-family: var(--font-display); }
        .archetype-role { color: var(--color-chessboard-smoke); font-size: 1rem; margin-bottom: 1rem; font-family: var(--font-body, serif); }
        .archetype-role strong { color: var(--color-chessboard-gold); }
        .archetype-narrative { color: var(--color-chessboard-smoke); line-height: 1.6; max-width: 700px; margin: 0 auto; font-size: 0.95rem; font-family: var(--font-body, serif); }
        .spider-chart { background: var(--color-chessboard-rampart); border: 1px solid var(--color-chessboard-ash); border-radius: 16px; padding: 1.5rem; margin-bottom: 2rem; }
        .spider-chart h3, .role-fit h3, .action-plan h3 { color: var(--color-chessboard-ivory); font-size: 1.1rem; margin-bottom: 1rem; font-family: var(--font-display); }
        ...
        .bar-value { width: 40px; text-align: right; font-weight: 600; font-size: 0.85rem; color: var(--color-chessboard-ivory); font-family: var(--font-data, monospace); }
        ...
        .cat-natural-dominant { background: rgba(16,185,129,0.12); color: var(--color-chessboard-verdant); }
        .cat-strong { background: rgba(59,130,246,0.12); color: var(--color-chessboard-sapphire); }
        .cat-functional { background: rgba(245,158,11,0.12); color: var(--color-chessboard-gold-bright); }
        .cat-development-required { background: rgba(239,68,68,0.12); color: var(--color-chessboard-crimson); }
        .cat-high-risk { background: rgba(239,68,68,0.2); color: var(--color-chessboard-crimson); }
        ...
        .role-name { font-size: 1.2rem; font-weight: 700; color: var(--color-chessboard-gold); margin-bottom: 0.5rem; font-family: var(--font-display); }
        .role-card p { color: var(--color-chessboard-smoke); font-size: 0.9rem; margin-bottom: 0.8rem; font-family: var(--font-body, serif); }
        .dominant-comps { display: flex; gap: 0.4rem; }
        .dom-comp { border: 1px solid; padding: 0.15rem 0.5rem; border-radius: 6px; font-size: 0.75rem; font-weight: 600; color: var(--color-chessboard-smoke); font-family: var(--font-display); }
        ...
        .action-comp { font-weight: 600; color: var(--color-chessboard-gold); font-size: 0.85rem; margin-bottom: 0.3rem; font-family: var(--font-display); }
        .action-item p { color: var(--muted-foreground); font-size: 0.9rem; margin: 0 0 0.3rem 0; font-family: var(--font-body, serif); }
        .target { font-size: 0.75rem; color: var(--color-chessboard-smoke); font-family: var(--font-data, monospace); }
