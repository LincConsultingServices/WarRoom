      ...
      <div className="text-center py-8 space-y-3">
        <div className="dynamic-scenario-border rounded-xl">
          <div className="p-5 text-sm text-center">
            <AlertTriangle className="h-5 w-5 mx-auto mb-2 text-[color:var(--color-chessboard-crimson-bright,#b03030)]" />
            <p className="text-[color:var(--color-chessboard-crimson-bright,#b03030)]">{dynamicScenarioError || 'Failed to generate scenario.'}</p>
          </div>
        </div>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isSelected
                  ? 'border-[color:var(--color-chessboard-gold)] bg-[color:var(--color-chessboard-gold)]/5 font-bold shadow-[0_0_12px_rgba(200,168,74,0.15)]'
                  : 'border-[color:var(--color-chessboard-gold)]/20 hover:border-[color:var(--color-chessboard-gold)]/50 hover:bg-[color:var(--color-chessboard-gold)]/5',
              )}
            >
              {opt.text}
            </button>
            ...
            <div className="space-y-3">
              <div className="dynamic-scenario-border rounded-xl">
                <div className="p-4 text-sm">
                  <div className="flex items-center gap-2 mb-2"><AlertTriangle className="h-4 w-4 text-[color:var(--color-chessboard-crimson-bright,#b03030)]" /><span className="font-bold text-[color:var(--color-chessboard-crimson-bright,#b03030)]">Follow-up Scenario Failed</span></div>
