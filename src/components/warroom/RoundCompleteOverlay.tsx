          ...
          >
            ...
            <button
              ...
              className={cn(
                ...
                'border-[color:var(--color-warroom-gold)]/45 bg-[color:var(--color-warroom-charcoal)]/60 text-[color:var(--color-warroom-gold)]',
                'hover:border-[color:var(--color-warroom-gold)]/85 hover:bg-[color:var(--color-warroom-charcoal)]/80 hover:shadow-[0_0_22px_rgba(200,168,74,0.35)]',
              )}
            >
